...
public class DefaultReconnectManager extends AbsReconnectionManager {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mDetach) {
                LogUtils.i("ReconnectionManager already detached by framework.We decide gave up this reconnection mission!");
                return;
            }
            ...
            LogUtils.i("Reconnect the server " + info.getIp() + ":" + info.getPort() + " ...");
            ...
            if (mConnectionFailedTimes > MAX_CONNECTION_FAILED_TIMES) {
                ...
                if (backupInfo != null) {
                    ...
                    if (!mConnectionManager.isConnect()) {
                        ...
                        LogUtils.i("Prepare switch to the backup line " + backupInfo.getIp() + ":" + backupInfo.getPort() + " ...");
                        mConnectionManager.connect();
                    }
                } else {
                    reconnectDelay();
    ...
    private boolean isNeedReconnect(Exception e) {
        synchronized (mIgnoreDisconnectExceptionList) {
            ...
            if (e != null && !(e instanceof PurifyException)) {
