...
import com.ldx.baseutils.utils.androidutilcode.constant.PermissionConstants;
...
//            StatusBarCompat.setStatusBarColor(this, Color.WHITE);//设置白色字体颜色为黑色
//            StatusBarCompat.setTranslucent(getWindow(), true);//状态栏透明
