 ...
 */
package com.ldx.baseutils.okrx2;

import android.graphics.Bitmap;

import com.ldx.baseutils.Urls;
...
public class ServerApi {
    ...
    public static Observable<String> postString(String url, HttpParams params) {
        return RxUtils.request(HttpMethod.POST, url, String.class, params, null);
    }
